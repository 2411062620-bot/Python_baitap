...
print(sinh_vien, ", diem cu xoa:", diem_cu)
...
diem_mon_hoc_3 = {"Toan": 8.0, "Ly": 7.5, "Hoa": 9.0, "Van": 6.5}
diem_cong_them = {mon: round(diem + 0.5, 2) for mon, diem in diem_mon_hoc_3.items()}
print(diem_cong_them)

ten_mon_viet_hoa = {mon.upper(): diem for mon, diem in diem_mon_hoc_3.items()}
